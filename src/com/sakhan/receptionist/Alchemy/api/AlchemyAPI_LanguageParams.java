...
public class AlchemyAPI_LanguageParams extends AlchemyAPI_Params
{
	...
	public void setSourceText( String sourceText )
	{
		...
		if( !sourceText.equals( AlchemyAPI_LanguageParams.CLEANED_OR_RAW ) && !sourceText.equals( AlchemyAPI_LanguageParams.CQUERY ) && !sourceText.equals( AlchemyAPI_LanguageParams.XPATH ) )
		{
