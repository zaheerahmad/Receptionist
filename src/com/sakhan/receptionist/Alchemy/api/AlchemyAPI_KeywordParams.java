...
public class AlchemyAPI_KeywordParams extends AlchemyAPI_Params
{
	...
	public void setSourceText( String sourceText )
	{
		...
		if( !sourceText.equals( AlchemyAPI_KeywordParams.CLEANED ) && !sourceText.equals( AlchemyAPI_KeywordParams.CLEANED_OR_RAW ) && !sourceText.equals( AlchemyAPI_KeywordParams.RAW ) && !sourceText.equals( AlchemyAPI_KeywordParams.CQUERY ) && !sourceText.equals( AlchemyAPI_KeywordParams.XPATH ) )
		{
	...
	public String getParameterString()
	{
		...
		try
		{
			...
			if( keywordExtractMode != null )
				retString += "&keywordExtractMode=" + URLEncoder.encode( keywordExtractMode, "UTF-8" );
		}
