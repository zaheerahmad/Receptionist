...
public class AlchemyAPI_RelationParams extends AlchemyAPI_Params
{
	...
	public void setSourceText( String sourceText )
	{
		...
		if( !sourceText.equals( AlchemyAPI_NamedEntityParams.CLEANED ) && !sourceText.equals( AlchemyAPI_NamedEntityParams.CLEANED_OR_RAW ) && !sourceText.equals( AlchemyAPI_NamedEntityParams.RAW ) && !sourceText.equals( AlchemyAPI_NamedEntityParams.CQUERY ) && !sourceText.equals( AlchemyAPI_NamedEntityParams.XPATH ) )
		{
	...
	public String getParameterString()
	{
		...
		try
		{
			...
			if( sentimentExcludeEntities != null )
				retString += "&sentimentExcludeEntities=" + ( sentimentExcludeEntities ? "1" : "0" );
